...
sample_alerts <- tibble(
  ...
  severity = c("warning", "warning", "warning", "warning", "warning", "warning", "warning", "warning", "violation"),
  conference = c("NFC", "NFC", "NFC", "NFC", "NFC", "NFC", "NFC", "NFC", "NFC"),
  franchise = c("ATL", "ATL", "ATL", "ATL", "ATL", "ATL", "ATL", "DET", "DET"),
  franchise_name = c(
    "Atlanta Falcons",
    "Atlanta Falcons",
    "Atlanta Falcons",
  ...
  observed = c(
    ...
    "Stevenson, Rhamondre NEP RB on Bye in Week 11.  Must replace with eligible RB/WR/TE.",
    "Deablo, Divine ATL LB on Bye in Week 11.  Must replace with eligible LB/CB/S.",
    "Witherspoon, Devon SEA CB on Bye in Week 11.  Must replace with eligible LB/CB/S.",
