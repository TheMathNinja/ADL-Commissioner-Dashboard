...
Unverified, conflicting, stale or failed live evidence makes recent unresolved status unknown, with `WAIVER STATUS UNKNOWN - CHECK MFL`. It is not silently treated as cleared. A blanket league lock also prevents interpreting individual absence as clearance. Unknown status does not trigger an automatic claim reversal. Salary, contract and manual-review notes remain intact.
